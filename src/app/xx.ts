...
export class AppComponent implements OnInit {
  ...
  fixtime() {
    this.timestamp.map((date) => {
      this.temp = new Date(this.timestamp[0]);
      this.correcttime.push(this.temp);
    });
  }
}

//?price. -> regularMarketPrice - correct price , currency - coin "USD"(example),
//?assetProfule. -> industry ,
